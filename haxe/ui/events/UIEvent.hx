...
class UIEvent extends EventImpl {
    ...
    /* RENDERER_CREATED is dispatched by table and list views when item renderer is created, the target property of the renderer is the item */
    public static final RENDERER_CREATED:EventType<UIEvent> = EventType.name("renderercreated");
    /* RENDERER_DESTROYED is dispatched by table and list views when item renderer is destroyed, the target property of the renderer is the item */
    ...
    /* Whether the event was canceled. If canceled, it won't t be dispatched to parent.

...
class Button2 extends InteractiveComponent {
    //***********************************************************************************************************
    // Styles
    //***********************************************************************************************************
...
private class ButtonLayout extends DefaultLayout {
    ...
    private function getTextAlignPos(label:Label, usableWidth:Float):Float {
        switch (cast(component, Button2).textAlign) {
            case "left":
...
@:dox(hide) @:noCompletion
@:access(haxe.ui.components.Button2)
private class ToggleBehaviour extends Behaviour {
    ...
    public override function set(value:Variant) {
        ...
        _value = value;
        var button:Button2 = cast(_component, Button2);
        if (value == false) {
...
private class Events extends haxe.ui.core.Events  {
    private var _button:Button2;
    private var _down:Bool = false;
    private var _repeatTimer:Timer;
    
    public function new(button:Button2) {
        super(button);
        _button = button;
    }

...
class DropDown_OLD extends Button implements IDataComponent {
    ...
    // Clonable
    //***********************************************************************************************************
    public override function cloneComponent():DropDown_OLD {
        if (_dataSource != null) {
...
@:dox(hide)
@:access(haxe.ui.components.DropDown_OLD)
class DropDownDefaultSelectedItemBehaviour extends Behaviour {
    public override function getDynamic():Dynamic {
        var dropDown:DropDown_OLD = cast(_component, DropDown_OLD);
        var lv:ListView = dropDown._listview;
        if (dropDown.dataSource == null || dropDown._selectedIndex == DropDown_OLD.NO_SELECTION) {
            return null;
        }

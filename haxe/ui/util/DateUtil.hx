...
class DateUtil {
    ...
    private static var DAY_NAMES:Array<String> = ["{{sunday}}", "{{monday}}", "{{tuesday}}", "{{wednesday}}", "{{thursday}}", "{{friday}}", "{{saturday}}"];
    private static var SHORT_DAY_NAMES:Array<String> = ["{{sun}}", "{{mon}}", "{{tues}}", "{{wed}}", "{{thur}}", "{{fri}}", "{{sat}}"];
